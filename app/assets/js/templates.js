angular.module('cardsandcharts').run(['$templateCache', function($templateCache) {
  'use strict';

  $templateCache.put('app/modules/album/album.html',
    "<div class=\"container\">\n" +
    "	<h1>Metal Albums</h1>\n" +
  ...
  $templateCache.put('app/modules/shared/directives/album-description/album.description.html',
    "<div class=\"card\">\n" +
    "  <div class=\"album\">\n" +
