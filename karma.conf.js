...
module.exports = function (config) {
	config.set({
		...
		files: [
			...
			'app/modules/album/albumModule.js',
			...
			'app/modules/album-sales/album-salesModule.js',
			'app/modules/album-sales/album.sales.controller.js',
			'app/modules/album-sales/album.sales.route.js',
			'app/modules/album-sales/album.sales.service.js',
			'app/modules/album-sales/album-sales.spec.js',
		],
